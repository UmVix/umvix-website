---
title: "Cross-platform vs native: when to build twice"
...
You are not choosing once for everything. [React Native and Flutter](/blog/react-native-vs-flutter) both let you write a native module for the 5% that needs it while the other 95% stays shared.
...
If the honest answer is "nothing, we just want an icon on the home screen", you may not need an app at all — [a fast web platform](/blog/nextjs-vs-wordpress) may serve you better. If the answer involves the camera, sensors, offline use, or background processing, we can tell you quickly which parts need native and which do not.

Whichever way it lands, the architecture decision flows straight into [what the build costs](/blog/how-much-does-a-mobile-app-cost) and [what you pay to keep it running](/blog/mobile-app-maintenance-cost).
