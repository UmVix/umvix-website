---
title: "How to write a website RFP that gets useful proposals"
description: "Most RFPs produce quotes that cannot be compared. A short template and the five questions that separate agencies who understood the brief from agencies who guessed."
date: 2026-08-12
...
**5. Who maintains it after launch.** A team with a developer and a team with one part-time marketer need different builds. This single answer changes the entire technology recommendation.

**6. Budget range and deadline.** Withholding budget does not get you a lower price; it gets you proposals aimed at the wrong tier. A range is enough.

## What to leave out

- Prescribed technology, unless you have a real constraint. "Must be WordPress" when you needed a web app narrows you to the wrong shortlist.
