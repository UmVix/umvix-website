...
Classify, tag, set priority, route to the right queue, and draft a suggested reply for a human to approve. Keep the human on send.
...
Multiply the first three, divide by the fourth. Start at the top of that list.
