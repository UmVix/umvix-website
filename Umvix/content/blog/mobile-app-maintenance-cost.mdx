---
title: "Mobile app maintenance: what it really costs after launch"
...
**Store policy deadlines.** Google Play enforces a minimum target API level and will stop serving your app to new users if you miss it. Apple periodically requires builds compiled against a newer SDK. These are hard deadlines with real consequences, set by someone else's calendar.
...
- **Platform count.** Two platforms, two sets of OS changes.
