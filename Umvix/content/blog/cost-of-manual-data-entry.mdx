---
title: "The hidden cost of manual data entry (and how to calculate yours)"
...
- **Custom integration:** $3,000–$15,000, plus hosting and maintenance.
...
- **Nobody has written it down.** Automate a broken process and you get a faster broken process.

## Where to start

Pick the process with the highest annual cost and the most stable rules. Automate that one, measure the actual saving after a month, and use the real number to justify the next one.
