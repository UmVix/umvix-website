...
5. **Be told something changed.** One [notification path](/blog/push-notifications-that-work), not a notification system.
...
A tight five-to-eight-flow MVP typically lands in the [$5,000–$12,000 band](/blog/how-much-does-a-mobile-app-cost) for one platform, or the lower end of $15,000–$35,000 [cross-platform](/blog/cross-platform-vs-native) with a real backend. The same idea with twenty flows does not cost twice as much; it costs three times as much and takes four times as long, because complexity compounds through testing.

Before you submit, run through [the App Store rejection checklist](/blog/app-store-rejection) — half of it is scope decisions you make now.
